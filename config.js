...
global.allowJids = process.env.ALLOW_JID || "923145269482@s.whatsapp.net";
global.blockJids = process.env.BLOCK_JID || "null";
global.DATABASE_URL = process.env.DATABASE_URL || "";
global.timezone = process.env.TZ || process.env.TIME_ZONE || "Asia/Karachi";
global.github = process.env.GITHUB || "https://github.com/Bootu-786/PRINCE-MD-V2";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "★彡[ꜰɪʟᴇ-ɢᴇɴᴇʀᴀᴛᴇᴅ-ʙʏ-ᴘʀɪɴᴄᴇ]彡★",
  author: process.env.PACK_AUTHER || "★彡[ᴘʀɪɴᴄᴇ]彡★",
  packname: process.env.PACK_NAME || "♥★彡[ᴘʀɪɴᴄᴇ]彡★",
  botname: process.env.BOT_NAME || "★彡[ᴘʀɪɴᴄᴇ]彡★",
  ownername: process.env.OWNER_NAME || "★彡[ᴘʀɪɴᴄᴇ]彡★",
  ...
  LANG: (process.env.THEME || "★彡[ᴘʀɪɴᴄᴇ]彡★").toUpperCase(),
};
global.rank = "updated";
